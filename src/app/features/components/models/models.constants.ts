/** Models section constants */
export const MODELS_BACKGROUND_SRC = 'https://www.figma.com/api/mcp/asset/5d1db5f4-0bbf-439d-a56d-55556ef781a3';
export const MODELS_YOUTUBE_URL = 'https://www.youtube.com/embed/ES-QrquEH8M?autoplay=1';
export const MODELS_ROW_DATA = [
  {
    title: 'Our Model',
    description:
